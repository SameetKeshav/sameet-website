    ...
    <section className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div>
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          Lorem ipsum dolor sit amet, consectetur adipisicing elit. Obcaecati officia, corporis inventore accusantium ex eum fugit deleniti itaque ab culpa laudantium ipsa, fugiat facere, repellat pariatur expedita! Id, est! Harum.
        </p>
