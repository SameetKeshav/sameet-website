    ...
    <section id="contact" className="grid md:grid-cols-2 my-12 md:my-12 py-24 gap-4 relative">
      ...
      <div>
        ...
        <p className="text-[#ADB7BE] mb-4 max-w-md">
          {" "}
          Please send me a message if you are interesting in working with me and I will try my best to get back to you as soon as possible. Thank You.
        </p>
        <div className="socials flex flex-row gap-2">
          <Link href='https://github.com/sameetkeshav'>
            <Image src={GitHubIcon} alt="Github Icon" />
          </Link>
          <Link href='https://www.linkedin.com/in/sameet-keshav-14b571195/'>
